...
_Json_ is a convenience wrapper for json encoding/decoding. Its main purpose is to make managing encoding/decoding options easy.
...
var_dump(Json::isValid('["oh, foo"', $e));  // bool (false)
